...
class GlobalReportBuilder:
    ...
    def generate_report(self, output_format: str = "pdf") -> str:
        ...
        pandoc_cmd = [
            ...
            temp_md_file,
            "-o", str(output_file),
            "--pdf-engine=xelatex" if output_format == "pdf" else None,
            "--template=eisvogel" if output_format == "pdf" else None,
            "--listings" if output_format == "pdf" else None,
            "--toc" if output_format == "pdf" else None,
            "--number-sections" if output_format == "pdf" else None
        ]
