...
# Les imports des modules de calculs sont faits localement dans chaque fonction
...
def convert_inp(
    ...
    try:
        ...
        if simulate:
            ...
            try:
                from .core.epanet_integration import run_epanet_with_diagnostics
...
def diagnose_network(
    ...
    try:
        ...
        try:
            from .core.network_diagnostics import diagnose_network_connectivity, validate_epanet_compatibility, analyze_network_topology
