Le fichier Markdown généré (formules_extraites.md) est très volumineux (>2 Mo), ce qui indique que le script a bien fonctionné et qu’il a extrait un grand nombre de formules.
