...
from lcpi_platform.lcpi_core.utils.ui_rich import (
    afficher_action,
    afficher_resultat,
    afficher_erreur,
...
from lcpi_platform.lcpi_beton.core.materials import Beton, Acier
from lcpi_platform.lcpi_beton.core.sections import SectionRectangulaire
from lcpi_platform.lcpi_beton.core.design.column_design import (
    design_rectangular_column,
    design_column_compression_bael,
)
from lcpi_platform.lcpi_beton.reports.plotting import plot_column_section
from lcpi_platform.lcpi_beton.core.analysis.continuous_beam import (
    analyze_by_forfaitaire,
)
from lcpi_platform.lcpi_beton.core.analysis.moment_calculator import (
    calculate_beam_end_moment,
)
from lcpi_platform.lcpi_beton.core.checks.service_limit_states import (
