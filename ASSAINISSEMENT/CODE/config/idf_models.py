...
DEFAULT_IDF_DATA = {
    ...
    "Lomé, Togo (Modèle: Kiefer-Chu, Source: Gbafa et al. 2017b)": {
        "formula": "kiefer-chu",
        "parameters": {
            '10': {'nom': 'Pluie T=10 ans', 'a': 700.0, 'b': 28.0, 'c': 1.35}, # Valeurs représentatives basées sur la tendance
    ...
    "Lomé, Togo (Modèle: Talbot, Source: Gbafa et al. 2017b)": {
        ...
        "parameters": {
            ...
            '20': {'nom': 'Pluie T=20 ans', 'a': 72.00, 'b': 14.50}, # Valeurs représentatives
